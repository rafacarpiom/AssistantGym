...
## 🟧 4. ¿Qué pasa si borras una rama?

### ✔ Si la rama YA está fusionada:
No se pierde nada. Los cambios están en `main`.

### ✔ Si la subiste a GitHub:
Aunque la borres localmente, **GitHub conserva toda la historia**.

### ❌ Si la borras sin hacer merge ni subirla:
Entonces sí se pierde.
...
Si necesitas una versión reducida tipo "chuleta rápida", puedo generarla también.
